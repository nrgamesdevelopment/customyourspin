...
image_mapping = {
    'Fitness': "{% static 'images/blog/fitness-wheel-fixed.svg' %}",
    'Creators': "{% static 'images/blog/social-wheel-fixed.svg' %}",
    'Events': "{% static 'images/blog/event-wheel-fixed.svg' %}",
    'Education': "{% static 'images/blog/classroom-wheel-fixed.svg' %}",
    'Guide': "{% static 'images/blog/wheel-placeholder-fixed.svg' %}",
    'default': "{% static 'images/blog/wheel-placeholder-fixed.svg' %}"
}

# Pattern to match static image tags with blog wheel SVGs
static_image_pattern = r'<img src="{% static \'images/blog/[^\']*\' %}"[^>]*>'
...
for filename in os.listdir(blog_templates_dir):
    if filename.endswith('.html') and filename != 'base.html' and filename != 'index.html':
        ...
        if '{% static' in content and '<img src=' in content and 'blog/' in content:
            ...
            print(f"Updated {filename} with fixed {category} image")

print("All blog templates have been updated with fixed wheel images!")